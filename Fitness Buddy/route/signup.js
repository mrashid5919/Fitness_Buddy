...
router.post('/signup2',(req,res)=>{
    ...
    const sql='INSERT INTO USERS(EMAIL,USERNAME,PASSWORD,FIRST_NAME,LAST_NAME,WEIGHT,HEIGHT,DATE_OF_BIRTH,GENDER,BMI,DESIRE) VALUES(:email,:username,:password, :firstname, :lastname, :weight, :height, :birthdate, :gender, :bmi, :desire)';
...
router.post('/addgoals',async(req,res)=>{
    ...
    const sql=`UPDATE GOALS SET DIET_TYPE=:diet_type, VITAMIN_C=:vit_c, IRON=:iron, SODIUM=:sodium, SUGAR=:sugar, DIETARY_FIBER=:fiber
